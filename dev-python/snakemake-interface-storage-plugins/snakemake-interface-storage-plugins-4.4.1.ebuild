...
SRC_URI="https://github.com/snakemake/snakemake-interface-storage-plugins/archive/refs/tags/v${PV}.tar.gz -> ${P}.gh.tar.gz"
...
RESTRICT="test" # requires separate ebuild for storage-http plugin
